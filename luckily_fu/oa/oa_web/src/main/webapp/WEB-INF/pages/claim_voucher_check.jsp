                    ...
                    <form:form id="admin-form" name="addForm" action="${pageContext.request.contextPath}/claim_voucher/check" modelAttribute="record">
                        ...
                        <div class="panel-body bg-light">
                            ...
                            <div class="panel-footer text-right">
                                ...
                                <button type="submit" class="button" name="deal_way" value="${Constant.DEAL_PASS}" >${Constant.DEAL_PASS}</button>
                                <button type="submit" class="button" name="deal_way" value="${Constant.DEAL_BACK}" >${Constant.DEAL_BACK}</button>
                                <button type="submit" class="button" name="deal_way" value="${Constant.DEAL_REJECT}" >${Constant.DEAL_REJECT}</button>
                                </c:if>
                                <c:if test="${sessionScope.employee.post==Constant.POST_CASHIER}">
                                <button type="submit" class="button" name="deal_way" value="${Constant.DEAL_PAID}" >${Constant.DEAL_PAID}</button>
                                </c:if>
