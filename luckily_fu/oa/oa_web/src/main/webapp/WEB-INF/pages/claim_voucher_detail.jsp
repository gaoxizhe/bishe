            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4"><fmt:formatDate value="${claimVoucher.create_time}" pattern="yyyy-MM-dd HH:ss:mm"></fmt:formatDate></div>
                    </div>
                    <div class="section row">
                    ...
                    <c:forEach items="${records}" var="record">
                        ...
                        <div class="col-md-3"><fmt:formatDate value="${record.deal_time}" pattern="yyyy-MM-dd HH:ss:mm"></fmt:formatDate></div>
