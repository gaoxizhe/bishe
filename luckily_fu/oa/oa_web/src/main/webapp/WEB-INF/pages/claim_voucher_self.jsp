                ...
                <div class="panel-menu">
                    <div class="row">
                        <div class="hidden-xs hidden-sm col-md-3">
                            <div class="btn-group">
                                <a href="${pageContext.request.contextPath}/claim_voucher/self" type="button" class="btn btn-default light">
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td><a href="${pageContext.request.contextPath}/claim_voucher/detail/${cv.id}">详细信息</a></td>
                        </tr>
                        </c:forEach>
                        </tbody>
                    </table>
