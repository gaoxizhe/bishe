<%@ page import="com.fgy.oa.domain.Employee" %>
        ...
        <div class="sidebar-left-content nano-content">
            <header class="sidebar-header">
                <div class="sidebar-widget author-widget">
                    <div class="media">
                        <a class="media-left" href="${pageContext.request.contextPath}/self">
            ...
            <ul class="nav sidebar-menu">
                ...
                <%
                    ...
                    if (employee.getDepartment_sn().equals("00000")) {
                        isShow = "visible";
                    } else {
                        isShow = "hidden";
                    }
                ...
                <li class="sidebar-label pt15" style="visibility: <%=isShow%>">基础信息管理</li>
                <li style="visibility: <%=isShow%>">
                    ...
                    <ul class="nav sub-nav">
                        <li>
                            <a href="${pageContext.request.contextPath}/employee/findAll">
