                        ...
                        <div class="panel-body bg-light p25 pb15">
                            <div class="section">
                                ...
                                <label for="sn" class="field prepend-icon">
                                    <input type="text" value="${cookie.sn.value}" name="sn" id="sn" class="gui-input" placeholder="请输入工号...">
                            ...
                            <div class="section">
                                ...
                                <label for="password" class="field prepend-icon">
                                    <input type="password" value="${cookie.password.value}" name="password" id="password" class="gui-input" placeholder="请输入密码...">
