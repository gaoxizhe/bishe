	...
	$.ajax({
		...
		success:function(data){
			var columns = [
				...
				{field: 'score', title: '会员积分', sortable: true, align: 'center', halign: 'center', valign: 'middle',},
				{field: 'processingTime', title: '办理时间', sortable: true, align: 'center', halign: 'center', valign: 'middle',
					formatter: function (value, row, index) {
						return changeDateFormat(value)
					}
				},
				{field: 'balance', title: '会员余额(￥)', sortable: true, align: 'center', halign: 'center', valign: 'middle',},
				{field: 'total', title: '消费总额(￥)', sortable: true, align: 'center', halign: 'center', valign: 'middle',},
