$(function(){
	...
	$.ajax({
		type:"post",
		url:"/petShop/getPetSalesAnalysis.html",
		dataType:"json",
		data:{},
		success:function(data){
			...
			var config3 = {
				...
				data: {
					datasets: [{
						data: data.petNoSalesEncyclopediasMap.total,
						backgroundColor: getColor(data.petNoSalesEncyclopediasMap.total),
						label: '宠物库存数量'
					}],
					labels: data.petNoSalesEncyclopediasMap.dataName
				},
				options: {
					responsive: true,
					legend: {
			...
			var ctx3 = document.getElementById('petNoSalesEncyclopedias').getContext('2d');
			...
			var config4 = {
				...
				data: {
					datasets: [{
						data: data.foodNoSalesAnalysisByCategoryMap.total,
						backgroundColor: getColor(data.foodNoSalesAnalysisByCategoryMap.total),
						label: '食品库存数量',
						borderWidth: 1,
					}],
					labels: data.foodNoSalesAnalysisByCategoryMap.dataName
			...
			var ctx4 = document.getElementById('foodNoSalesAnalysisByCategory').getContext('2d');
			window.myPie = new Chart(ctx4, config4);


			/*console.info("顶顶顶",data[7]["total"])*/
			/*//宠物最畅销品种
			var config5 = {
				type: 'horizontalBar',
				data: {
...
function getPetSalesEncyclopediasHighest(pageSize){
	...
	$.ajax({
		type:"post",
		url:"/petShop/getPetSalesEncyclopediasHighest.html",
		dataType:"json",
		data:{
			pageSize:pageSize
		},
...
function getFoodSalesAnalysisHighes(pageSize){
	...
	$.ajax({
		type:"post",
		url:"/petShop/getFoodSalesAnalysisHighes.html",
		dataType:"json",
		data:{
			pageSize:pageSize
		},
...
function getPetSalesNumberAnalysis(startTime,endTime,type) {
	$.ajax({
		type:"post",
		url:"/petShop/getPetSalesNumberAnalysis.html",
		dataType:"json",
		data:{
