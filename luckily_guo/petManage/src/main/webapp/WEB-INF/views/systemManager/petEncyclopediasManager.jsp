...
<div class="container-fluid" style="width: calc(100% - 250px);margin-left: 250px;overflow: auto;">
    <div class="row top">
        ...
        <div class="pull-right top-position">爱宠乐 <span style="margin:0 5px;">/</span>数据管理<span style="margin:0 5px;">/</span><span class="top-position-name">宠物百科管理</span></div>
    </div>
    <div class="row shop-member">
        <div class="col-lg-12 shop-member-content">
            <div class="row shop-member-top">
                <div class="pull-left shop-member-top-name"><i class="fa fa-user"></i>宠物百科</div>
                <div class="pull-right shop-member-top-button">
                    <button class="btn btn-primary" id="addEncyclopedias"><i class="fa fa-user-plus" aria-hidden="true"></i>新增</button>
                </div>
            </div>
...
<script src="${pageContext.request.contextPath}/statics/js/systemModule/petEncyclopediasManager.js"></script><!-- 使用 -->
<!-- 弹窗 -->
