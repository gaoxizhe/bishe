...
<head>
    ...
    <!-- 图标 -->
    <link href="${pageContext.request.contextPath}/statics/widget/font-awesome-4.7.0/css/font-awesome.min.css"
          rel="stylesheet">
</head>
<body>
<nav class="navbar navbar-default navbar-static-top ">
    <div class="pull-left"><a href="${pageContext.request.contextPath}/index.html" class="logo"><img alt="Logo"
                                                                                                     src="${pageContext.request.contextPath}/statics/img/logo2.png"/><%-- <span>宠物猫</span>--%>
    </a></div>
        ...
        <div class="pull-left nav-right1 ">
            ...
            <div class="personal-msg">
                ...
                <a href="${pageContext.request.contextPath}/open/userCenter.html">
                    <div class="person person-all-msg"><i class="fa fa-user"></i>个人信息</div>
                </a>
                <a href="${pageContext.request.contextPath}/open/index.html" target="_blank">
                    <div class="person person-all-msg"><i class="fa fa-desktop"></i>宠物猫官网</div>
                </a>
                <a href="${pageContext.request.contextPath}/petIndex.html" target="_blank">
                    <div class="person person-all-msg"><i class="fa fa-paw"></i>我的宠物店</div>
                </a>
                <a href="${pageContext.request.contextPath}/logout">
                    <div class="person logout"><i class="fa fa-sign-out"></i>退出登录</div>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                <li>
                    <a id="indexPage" href="${pageContext.request.contextPath}/system/systemIndex.html"><i
                            class="fa fa-th-large"></i> 首页</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/system/petShopApplicationAudit.html"><i
                            class="fa fa-hand-pointer-o"></i> 宠物店申请审核</a>
                </li>
                <li>
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/system/petShopManager.html"><i class="fa fa-paw"></i>
                        宠物店管理</a>
                </li>
                <li>
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/system/permissionManager.html"><i
                            class="fa fa-user"></i> 用户权限管理</a>
                </li>
