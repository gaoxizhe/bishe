...
<div class="container-fluid" style="width: calc(100% - 250px);margin-left: 250px;overflow: auto;">
    <div class="row top">
        ...
        <div class="pull-right top-position">爱宠乐 <span style="margin:0 5px;">/</span>会员管理<span style="margin:0 5px;">/</span><span class="top-position-name">会员充值记录</span></div>
    </div>
    <div class="row shop-member">
        <div class="col-lg-12 shop-member-content">
            <div class="row shop-member-top">
                <div class="pull-left shop-member-top-name"><i class="fa fa-bars"></i>会员充值记录</div>
            </div>
...
<script src="${pageContext.request.contextPath}/statics/js/petShopPage/pet-shop-member-record-table-use.js"></script><!-- 使用 -->
<!-- 弹窗 -->
