    ...
    <div class="row shop-member">
        <div class="col-lg-12 shop-member-content">
            <div class="row shop-member-top">
                <div class="pull-left shop-member-top-name"><i class="fa fa-shopping-bag"></i>周边商品库存</div>
                <div class="pull-right shop-member-top-button">
                    <button class="btn btn-primary" id="addPage"><i class="fa fa-plus-circle" aria-hidden="true"></i>新增周边商品</button>
                </div>
            </div>
...
<script src="${pageContext.request.contextPath}/statics/js/petShopPage/pet-shop-peripheryStock.js"></script><!-- 使用 -->
<!-- 弹窗 -->
