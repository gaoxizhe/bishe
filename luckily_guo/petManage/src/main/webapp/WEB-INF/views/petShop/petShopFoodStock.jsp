...
<div class="container-fluid" style="width: calc(100% - 250px);margin-left: 250px;overflow: auto;">
    <div class="row top">
        ...
        <div class="pull-right top-position">爱宠乐 <span style="margin:0 5px;">/</span>库存管理<span style="margin:0 5px;">/</span><span class="top-position-name">食品库存</span></div>
    </div>
    <div class="row shop-member">
        <div class="col-lg-12 shop-member-content">
            <div class="row shop-member-top">
                <div class="pull-left shop-member-top-name"><i class="fa fa-cutlery"></i>食品库存</div>
                <div class="pull-right shop-member-top-button">
                    <button class="btn btn-primary" id="addFoodToFoodPage"><i class="fa fa-plus-circle" aria-hidden="true"></i>新增食品</button>
                </div>
            </div>
...
<script src="${pageContext.request.contextPath}/statics/js/petShopPage/pet-shop-foodStock-table-use.js"></script><!-- 使用 -->
<!-- 弹窗 -->
