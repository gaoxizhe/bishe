...
//        return df.format(new Date());
     ...
     * @date
     */
    public static String StringToDateYearMonth(String dateString,String dateType) throws Exception{
    ...
    /* *
     *功能描述:将时间转为字符串年月并可以加月份
     * @author zy
     * @date
     */
    public static String DatePlusToString(String dateString,int month,String StringType) throws Exception{
        SimpleDateFormat df = new SimpleDateFormat(StringType);//设置日期格式
        Date date = df.parse(dateString);
        Calendar rightNow = Calendar.getInstance();
        rightNow.setTime(date);
        rightNow.add(Calendar.MONTH, month);
        String reStr = df.format(rightNow.getTime());
        return reStr;
    }

    /* *
     *功能描述:将时间转为字符串年月并可以加日
     * @author zy
     * @date
     */
    public static String DateDayPlusToString(String dateString,int day,String StringType) throws Exception{
        SimpleDateFormat df = new SimpleDateFormat(StringType);//设置日期格式
        Date date = df.parse(dateString);
        Calendar rightNow = Calendar.getInstance();
        rightNow.setTime(date);
     ...
     * @date
     */
    public static String getMonthFirstData() throws Exception{
        // 获取当月第一天
        Calendar cale = null;
     ...
     * @date
     */
    public static String getNowDay(int num) throws Exception{
     ...
     * @return
     */
    public static List<String> getImgPath(String imgPath){
