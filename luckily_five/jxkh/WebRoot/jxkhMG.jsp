	...
	<div class="widget-title">
	  ...
	  <p>
	  	...
	  	<table class="table table-bordered table-hover table-striped">
			...
			<%}else{%>
			<th>编号</th><th class="span8">项&nbsp;&nbsp;目&nbsp;&nbsp;名</th>
			<th >类&nbsp;别</th>
			<th class="span2">管&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;理</th>
			</tr>			
			<%
			//分页实现代码从此开始
			  ...
			  if(strPage==null){//表明在ＱueryString中没有page这个参数，则显示第一页数据
			   ...
			   {//将记录指针定位到待显示页的第一条记录上．
				...
				for(i=(intPage-1)*intPageSize;k<intPageSize && i<intRowCount;i++){
						out.print("<tr>");
						int _id = list.get(i).getPerfID(); 
						out.print("<td>"+_id+"</td>");
						out.print("<td>"+list.get(i).getPerfName()+"</td>");
						out.print("<td>"+list.get(i).getPerfClass()+"</td>");
...
<!-- jQuery -->
    ...
    <script>
    function Add(){
   		var url='AddPerformanceServlet?t='+Math.random(1000);
    ...
    function Edit(id){
    	var url='EditPerformanceServlet?id='+id+'&t='+Math.random(9999);   			
     		$.get(url,null,function(data){
    ...
    function Del(id){
   		var url='DelPerformanceServlet?id='+id+'&t='+Math.random(1000);
